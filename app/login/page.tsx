        ...
        <div data-theme={theme} className="min-h-screen w-full bg-sys-bg font-mono text-sys-fg flex flex-col items-center justify-center p-4 transition-colors duration-300">
            ...
            <div className="w-full max-w-md bg-sys-bg border border-sys-border shadow-[0_0_20px_var(--sys-shadow)] p-8 relative">
                ...
                <div className="flex flex-col items-center border-b border-sys-border pb-6 mb-6">
                    ...
                    <h1 className="text-2xl font-bold tracking-widest text-sys-accent">SYS_LOGIN</h1>
                    <p className="text-xs text-sys-muted-light mt-2 uppercase">Autenticação Requerida</p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                        <label className="block text-xs uppercase text-sys-muted-light mb-2">E-mail</label>
                        <input
                            type="email"
                            required
                            value={email}
                    ...
                    <div>
                        <label className="block text-xs uppercase text-sys-muted-light mb-2">Senha</label>
                        <input
                            type="password"
                            required
                            value={password}
                ...
                <div className="mt-8 text-center border-t border-sys-border/50 pt-6">
                    <p className="text-xs text-sys-muted">
                        ...
                        <Link href="/login/register" className="text-sys-accent hover:text-sys-accent-light font-bold mt-2 inline-block transition-colors">
                            [ CRIAR NOVA CONTA ]
                        </Link>
                    </p>
                </div>
