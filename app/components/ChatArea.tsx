...
export default function ChatArea({
  ...
  return (
      <div className="flex-1 flex flex-col h-full relative overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 pt-16 md:p-8 md:pt-16 w-full flex flex-col">

          {!messages || messages.length === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center pb-32 select-none pointer-events-none opacity-80">
                <h1 className="text-5xl md:text-7xl font-bold tracking-widest text-sys-accent mb-2 opacity-20">
                  Botboy
                </h1>
                <span className="text-sm md:text-base tracking-[0.3em] text-sys-muted-light opacity-20">
                  ChatBot by Izuki
                  <span className="inline-block w-2 md:w-3 h-4 md:h-5 bg-sys-accent ml-2 animate-blink shadow-[0_0_8px_var(--sys-accent)]"></span>
                </span>
              </div>
          ) : (
